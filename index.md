...
=======
      <a href="assets/docs/profile/Elsadany-resume_070426.pdf" class="contact-link">
>>>>>>> ee3287a6586df2a9c2ffd18c99e0b770774fc8b3
...
=======
        <a href="assets/docs/profile/Elsadany-resume_070426.pdf" class="link-button" target="_blank">
>>>>>>> ee3287a6586df2a9c2ffd18c99e0b770774fc8b3
          ↓ Download Resume (PDF)
        </a>
      </div>
...
const galleryImages = [
  { src: 'assets/gallery/arch-1.png', caption: 'Archetypal Analysis for Text' },
  ...
  { src: 'assets/gallery/iq-2.png', caption: 'Recruitment' },
  { src: 'assets/gallery/wc-1.png', caption: 'Task Responses over Time' },
  { src: 'assets/gallery/sche-1.png', caption: 'Slides Example' },
  { src: 'assets/gallery/thesis-overview-1.jpg', caption: 'Thesis Overview' },
  { src: 'assets/gallery/sche-2.png', caption: 'Slides Example' },
  { src: 'assets/gallery/line-2.png', caption: 'Time Series' },
  { src: 'assets/gallery/resid-1.png', caption: 'Residual Analysis' },
  { src: 'assets/gallery/rad-1.svg', caption: 'Radar Plot' },
  { src: 'assets/gallery/ne-1.jpg', caption: 'NEUROeSTIMator Activity Differences' },
  { src: 'assets/images/drug-maps/overview.jpg', caption: 'Drug Response Map Pipeline' },
  { src: 'assets/gallery/bar-1.png', caption: 'Prediction Models Summary' },
  { src: 'assets/gallery/bm-v1.jpg', caption: 'Predicted Brain Maps' },
  { src: 'assets/gallery/cyto-1.jpg', caption: 'Gene Network Analysis' },
  { src: 'assets/gallery/den-1.png', caption: 'Density Plot' },
  { src: 'assets/gallery/den-2.png', caption: 'Density Distribution' },
  { src: 'assets/gallery/euc-1.jpg', caption: 'Semantic Euclidean Distance' },
  { src: 'assets/gallery/fALFF-1.png', caption: 'fALFF Derivation' },
  { src: 'assets/gallery/forest-1.png', caption: 'Forest Plot' },
  { src: 'assets/gallery/dti-res-1.png', caption: 'RF DTI Results' },
  { src: 'assets/gallery/jeo-1.png', caption: 'Jeopardy Facial Landmarking' },
  { src: 'assets/gallery/loli-1.png', caption: 'Lollipop Chart' },
  { src: 'assets/gallery/mo-1.png', caption: 'Cell-Cell Activity Alignment' },
  { src: 'assets/gallery/mph-1.svg', caption: 'Methylphenidate Activity Mapping' },
  { src: 'assets/gallery/net-2.png', caption: 'Network Plots' },
  { src: 'assets/gallery/peaks-1.jpg', caption: 'ATAC Peak Visualization' },
  { src: 'assets/gallery/scat-1.png', caption: 'Scatter Plot' },
  { src: 'assets/gallery/sel-1.jpg', caption: 'Slides Example' },
  { src: 'assets/gallery/sem-2.jpg', caption: 'SEM Example Results' },
  { src: 'assets/gallery/st.png', caption: 'Mouse Brain Spatial Transcriptomics' },
